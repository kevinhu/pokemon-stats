...
summary(pc1)
```
It seems that principal component 1 contains most (over 99%) of the observed variance. 
...
ggplot(data = pokemons_df, aes_string(x='PC1', y='PC2')) + 
    geom_point(aes(color = factor(type_primary))) + 
...
From this biplot, it seems that there is no noticeable clustering of Pokemon based on primary type using the first two principal components. 
